...
public enum ModArmorMaterial implements IArmorMaterial {
    POWERARMOR("power_armor", 60, new int[] {7, 10, 12, 7}, 13,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 6.0f, 0.2F, () -> {
        return Ingredient.of(ModRegistry.Whm_logo1.get());
    });
    ...
    @OnlyIn(Dist.CLIENT)
    public String getName() { return Whm.MOD_ID + ":" + this.name; }
